...
const Table: React.FC = () => {
    ...
    const handleChange = (row: DataType, rowIndex: number, colIndex: number, value: string) => {
    //   const newData = [...data];
                    ...
                    <tr key={rowIndex}>
                        <td>
                            <Input
                                ...
                                onChange={(e) => handleChange(row, rowIndex, 0, e.target.value)}
                                style={{ width: '100%' }}
                            />
                        </td>
                        <td>
                            <Input
                                ...
                                onChange={(e) => handleChange(row, rowIndex, 1, e.target.value)}
                                style={{ width: '100%' }}
                            />
                        </td>
                        <td>
                            <Input
                                ...
                                onChange={(e) => handleChange(row, rowIndex, 2, e.target.value)}
                                style={{ width: '100%' }}
                            />
                        </td>
                        <td>
                            <Input
                                ...
                                onChange={(e) => handleChange(row, rowIndex, 3, e.target.value)}
                                style={{ width: '100%' }}
                            />
                        </td>
                        <td>
                            <Input
                                ...
                                onChange={(e) => handleChange(row, rowIndex, 4, e.target.value)}
                                style={{ width: '100%' }}
                            />
                        </td>
                        <td>
                            <Input
                                ...
                                onChange={(e) => handleChange(row, rowIndex, 5, e.target.value)}
                                style={{ width: '100%' }}
                            />
                        </td>
                    </tr>
